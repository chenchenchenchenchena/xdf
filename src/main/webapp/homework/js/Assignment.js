            ...
            ajaxRequest('post',homework_s.t_seac,{'Tcid': sessionStorage.id_x},function(e){
                ...
                for(var b  = 0;b<tea.length;b++){
                    if(tea[b].fileType=='mp3'){
                        $('.big_s').eq(0).append('<div class="music_s" fileName="'+tea[b].fileName+'" fileType="'+tea[b].fileType+'" fileSize="'+tea[b].fileSize+'" diskFilePath="'+tea[b].diskFilePath+'"><span>10"</span> <audio  src="'+tea[b].previewUrl+'" id="bgMusic"></audio ></div>')
                    }else{
                        $('.imgBox').show();
