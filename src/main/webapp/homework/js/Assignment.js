$(function () {
    ...
    ajax_S(homework_s.t_clas, trardata, function (e) {
        ...
        for (var a = 0; a < className.length; a++) {
            $('.class_name ul').append('<li classCode="' + className[a].ClassCode + '"><img src="images/C05_06.png" alt=""><span>'+ className[a].ClassName + '</span><b style="font-size:25px;font-family:normal;position:relative;">（'+className[a].ClassCode+'）</b></li>')
        }
