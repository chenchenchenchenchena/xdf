...
require(['jquery-1.11.0.min'], function () {
    require(['layer'],function() {
        ...
        $('.homework_sea input').on('keyup',function(event){
            if(event.keyCode==40){
                //下键盘
                if($('.adduser_list_active')){
                    $('.adduser_list').find('li').eq($('.adduser_list_active').index()+1).addClass('adduser_list_active').siblings().removeClass('adduser_list_active')
                }else{
                    $('.adduser_list').find('li').eq(0).addClass('adduser_list_active').siblings().removeClass('adduser_list_active')
                }
                ...
                if(event.which==13){
                    if($('.adduser_list_active')){
                        $('.homework_sea input').val($('.adduser_list_active').html());
                        $('.homework_sea input').attr('name',$('.adduser_list_active').attr('name'));
                        $('.adduser_list').hide();
