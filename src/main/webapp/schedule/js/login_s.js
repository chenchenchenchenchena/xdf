$(function(){
    ...
    function name_se(e){
        ...
        for(var i = 0;i<studentNo.length;i++){
            ...
            $('.stuNum').append('<li class="new_S"><span>学员号'+(i+1)+':</span><span class="stu_num">'+studentNo[i].stNo+'</span><span style="margin-left:.5rem">'+studentNo[i].stName+'</span><button class="Relation">'+bindz+'</button></li>')
